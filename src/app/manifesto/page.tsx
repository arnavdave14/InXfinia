...
export default function ManifestoPage() {
  ...
  return (
    <>
      ...
      <main ref={containerRef} className="relative z-10 min-h-screen pt-40 pb-0 overflow-hidden px-6 md:px-12 selection:bg-violet-600 selection:text-white" style={{ perspective: "1000px" }}>
        
        <div className="max-w-[1600px] mx-auto relative z-20">
          
          <div className="declare-title mb-40 md:mb-64">
          ...
          <div className="flex flex-col gap-32 md:gap-48 w-full">
            ...
            <div className="flex flex-col w-full">
              <h2 className="slide-left font-syne text-[clamp(4rem,10vw,12rem)] font-black leading-[0.8] tracking-tighter uppercase text-transparent" style={{ WebkitTextStroke: "2px #5B21B6" }}>
                We Reject
              </h2>
              <h2 className="slide-right font-syne text-[clamp(4rem,10vw,12rem)] font-black leading-[0.8] tracking-tighter uppercase text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-emerald-500 self-end md:mt-4">
                The Black Box.
              </h2>
            </div>

            {/* Block 2 */}
            <div className="flex flex-col items-center justify-center w-full my-12 md:my-24">
              <h2 className="tilt-3d font-syne text-[clamp(3rem,6vw,8rem)] font-bold leading-[0.9] tracking-tighter uppercase text-center text-[#090A0F] max-w-5xl mx-auto">
            ...
            <div className="flex flex-col w-full">
              <h2 className="slide-left font-syne text-[clamp(4rem,9vw,10rem)] font-black leading-[0.85] tracking-tighter uppercase text-[#090A0F]">
                Latency is the
              </h2>
              <div className="slide-right flex items-center justify-end flex-wrap gap-4 md:gap-8 mt-4">
                {/* Spinning abstract shape */}
                <svg viewBox="0 0 100 100" className="spin-element w-[12vw] h-[12vw] max-w-[150px] max-h-[150px] fill-emerald-500">
                  <path d="M50 0 L60 40 L100 50 L60 60 L50 100 L40 60 L0 50 L40 40 Z" />
                </svg>
                <h2 className="font-syne text-[clamp(4rem,9vw,10rem)] font-black leading-[0.85] tracking-tighter uppercase text-transparent" style={{ WebkitTextStroke: "2px #111" }}>
                  Enemy of Thought.
                </h2>
              </div>
            </div>
            ...
            <div className="flex flex-col w-full mt-12 md:mt-24">
              <h2 className="tilt-3d font-syne text-[clamp(5rem,13vw,16rem)] font-black leading-[0.75] tracking-tighter uppercase text-center text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-emerald-500">
                NO MORE
              </h2>
              <h2 className="tilt-3d font-syne text-[clamp(5rem,13vw,16rem)] font-black leading-[0.75] tracking-tighter uppercase text-center text-transparent" style={{ WebkitTextStroke: "2px #10b981" }}>
                LOCK-IN.
              </h2>
            </div>

            {/* Block 5 */}
            <div className="flex flex-col items-start w-full relative mt-32">
              <div className="absolute -left-10 md:-left-20 top-0 bottom-0 w-1 bg-gradient-to-b from-violet-600 to-emerald-500 origin-top scale-y-0 slide-left" />
              <p className="slide-right font-mono text-sm md:text-base uppercase tracking-widest text-[#555] max-w-lg mb-8">
                We are building the open neural fabric of the internet.
              </p>
              <h2 className="slide-left font-syne text-[clamp(3rem,8vw,10rem)] font-black leading-[0.85] tracking-tighter uppercase text-[#090A0F]">
                Intelligence <br/>
                <span className="text-transparent" style={{ WebkitTextStroke: "3px #5B21B6" }}>Redefined.</span>
              </h2>
            </div>
          ...
          {/* CTA */}
          <motion.div 
            className="mt-64 mb-16 flex justify-center tilt-3d"
            initial={{ opacity: 0 }}
          ...
          <motion.div
            ...
            className="overflow-hidden w-full -mx-6 md:-mx-12 px-6 md:px-12"
          >
            <motion.div
              initial="hidden"
              animate={isWhitepaperOpen ? "visible" : "hidden"}
              variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.12, delayChildren: 0.3 } } }}
              className="w-full border-t-4 border-[#090A0F]"
            >

              {/* Dossier Header */}
              <motion.div
                variants={{ hidden: { y: 60, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8, ease: [0.16,1,0.3,1] } } }}
                className="border-b-2 border-[#090A0F] flex flex-col md:flex-row justify-between items-start md:items-end py-8 px-0 gap-4"
              >
                <h3 className="font-syne text-[clamp(2rem,5vw,5rem)] font-black uppercase leading-[0.85] tracking-tighter text-[#090A0F]">
                  The InXfinia<br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-emerald-500">Architecture</span>
                </h3>
                <div className="text-right font-mono text-xs uppercase tracking-widest text-[#555] leading-relaxed">
                  <p>Draft v1.0</p>
                  <p>Confidential</p>
                  <p className="text-violet-600 font-bold">InXfinia Research Lab</p>
                </div>
              </motion.div>
              ...
              >
                <div className="md:border-r-2 border-[#090A0F] py-12 px-8 flex items-start justify-center">
                ...
                <div className="py-12 px-8 md:px-16 flex flex-col justify-center">
              ...
              >
                <div className="py-12 px-8 md:px-16 flex flex-col justify-center order-2 md:order-1">
                ...
                <div className="md:border-l-2 border-[#090A0F] py-12 px-8 flex items-start justify-center order-1 md:order-2">
              ...
              >
                ...
                <h2 className="font-syne text-[clamp(2.5rem,7vw,8rem)] font-black uppercase tracking-tighter leading-[0.85] text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-emerald-500">
              ...
              <motion.div
                ...
                className="border-t-2 border-[#090A0F] py-4 overflow-hidden"
              >
